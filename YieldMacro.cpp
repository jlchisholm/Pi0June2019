...
//                                                                           //
//  Temporary macro to check that the yield is correctly calculated.         //
//                                                                           //
///////////////////////////////////////////////////////////////////////////////
...
//    TH1D *hElastic = new TH1D("hElastic", Form("Counts of Elastic Pi0 Production for KE=%d",ke),18,0,180);
...
//    // Go through the theta(given here by bin number) and fill the histogram
